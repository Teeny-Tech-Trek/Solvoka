...
export default function UtilityBar() {
  return (
    <div id="utility-bar" className="relative z-40 w-full h-[38px] overflow-hidden bg-white border-b border-grey-200 text-black shadow-xs">
      <div className="mx-auto flex h-[38px] max-w-[1536px] flex-wrap items-center justify-center gap-x-2.5 sm:gap-x-6 gap-y-0.5 px-2 sm:px-4 text-[10.5px] xs:text-[11px] sm:text-[13px] tracking-wide lg:px-10">
        {/* Email */}
        <a
        ...
        >
          ...
          <span className="font-semibold text-black whitespace-nowrap">solvoka@gmail.com</span>
        </a>

        <span className="hidden sm:inline text-grey-300 select-none" aria-hidden="true">|</span>
        ...
        >
          ...
          <span className="font-semibold text-black whitespace-nowrap">+91 70870-86696</span>
        </a>

        <span className="hidden md:inline text-grey-300 select-none" aria-hidden="true">|</span>
        ...
        >
          ...
          <span className="font-semibold text-black whitespace-nowrap">WhatsApp Business</span>
        </a>
      </div>
    </div>
  );
