...
export default function AboutUsHero() {
  return (
    <section className="relative w-full overflow-hidden bg-white pt-20 pb-10 sm:pt-24 sm:pb-12 lg:pt-28 lg:pb-16 min-h-[520px] sm:min-h-[600px] xl:min-h-[720px] flex items-center">
      {/* ============================================================ */}
      ...
      <div className="pointer-events-none absolute inset-0 select-none overflow-hidden" aria-hidden="true">
        ...
        {/* Mobile: full white overlay so text is readable over the background image */}
        <div
          className="absolute inset-0 pointer-events-none block lg:hidden"
          style={{
            background:
              "linear-gradient(180deg, rgba(255,255,255,0.97) 0%, rgba(255,255,255,0.95) 60%, rgba(255,255,255,0.85) 100%)",
          }}
        />

        {/* Desktop: left-only gradient wash */}
        <div
      ...
      <div className="relative z-20 mx-auto w-full max-w-[1560px] px-6 sm:px-10 lg:px-14 xl:px-16">
        <div className="max-w-xl lg:max-w-2xl">
          ...
          <div className="mt-5 flex items-center gap-2.5">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.22em] text-[#2563eb]">
              ABOUT SOLVOKA
            </span>
          </div>

          {/* Main Headline */}
          <h1 className="mt-3.5 text-4xl font-extrabold tracking-tight text-[#2563eb] sm:text-5xl lg:text-[56px] xl:text-[62px] leading-[1.06]">
            Precision
            <br />
            Manufacturing,
            <br />
            <span className="text-[#2563eb]">A Proven Network</span>
          </h1>

          {/* Subheading Description: backdrop blur specifically behind this text only */}
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-slate-900 max-w-xl backdrop-blur-md bg-white/40 rounded-xl p-3 sm:p-4 border border-white/30 shadow-xs">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4">
            <Link
              to="/contact-us"
              className="inline-flex items-center gap-2 rounded-xl bg-[#2563eb] px-7 py-3 text-sm font-semibold text-white shadow-md shadow-[#2563eb]/25 transition-all hover:bg-[#2563eb] active:scale-[0.98]"
            >
            ...
            <Link
              to="/#capabilities"
              className="inline-flex items-center rounded-xl border border-slate-300/90 bg-white/90 px-6 py-3 text-sm font-semibold text-slate-800 shadow-xs transition-colors hover:bg-white hover:border-slate-400"
            >
              View Capabilities
            </Link>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 xs:grid-cols-3 sm:grid-cols-3 sm:gap-3.5 max-w-xl lg:max-w-2xl">
            {/* Card 1: Home Base */}
            <div className="flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white/90 p-3.5 shadow-sm backdrop-blur-xs transition-transform duration-200 hover:-translate-y-0.5">
              ...
              <div className="min-w-0">
                <span className="block text-[9px] font-bold uppercase tracking-[0.16em] text-slate-400 leading-tight">
                  HOME BASE
                </span>
                <span className="block text-[13px] font-bold text-slate-900 leading-tight mt-0.5 truncate">
          ...
          <div className="mt-8 flex items-center gap-3">
            ...
            <span className="text-[10px] sm:text-[10.5px] font-semibold tracking-[0.2em] text-slate-400 uppercase">
