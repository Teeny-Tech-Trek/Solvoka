    ...
    return (
        <div className="relative w-full select-none">
            <svg viewBox="0 0 420 320" className="h-full w-full" aria-hidden="true">
                ...
                <line x1="20" y1="270" x2="400" y2="270" stroke="#e2e8f0" strokeWidth="1" />
                <line x1="20" y1="190" x2="400" y2="190" stroke="#e2e8f0" strokeWidth="1" />
                <line x1="20" y1="110" x2="400" y2="110" stroke="#e2e8f0" strokeWidth="1" />

                {/* Central Hub: Solvoka QA & Engineering Hub */}
                <g transform="translate(210, 160)">
                    {/* Concentric Signal Rings */}
                    <circle cx="0" cy="0" r="85" fill="none" stroke="rgba(37, 99, 235, 0.1)" strokeWidth="1" strokeDasharray="3 3" />
                    <circle cx="0" cy="0" r="55" fill="none" stroke="rgba(37, 99, 235, 0.2)" strokeWidth="1" />

                    {/* Central Hub Core */}
                    <circle cx="0" cy="0" r="22" fill="#2563eb" stroke="#2563eb" strokeWidth="1.5" />
                    <text x="0" y="4" textAnchor="middle" fill="#ffffff" fontSize="8" fontWeight="bold">
                        HUB
                    </text>

                    {/* Node 1: Forging (Top Left) */}
                    <line x1="-16" y1="-16" x2="-95" y2="-75" stroke="#2563eb" strokeWidth="1" strokeDasharray="2 2" />
                    <circle cx="-105" cy="-85" r="14" fill="#ffffff" stroke="#2563eb" strokeWidth="1.2" />
                    <text x="-105" y="-82" textAnchor="middle" fill="#2563eb" fontSize="7" fontWeight="bold">FORGE</text>

                    {/* Node 2: CNC Machining (Top Right) */}
                    <line x1="16" y1="-16" x2="95" y2="-75" stroke="#2563eb" strokeWidth="1" strokeDasharray="2 2" />
                    <circle cx="105" cy="-85" r="14" fill="#ffffff" stroke="#2563eb" strokeWidth="1.2" />
                    <text x="105" y="-82" textAnchor="middle" fill="#2563eb" fontSize="7" fontWeight="bold">CNC</text>

                    {/* Node 3: Casting (Bottom Left) */}
                    <line x1="-16" y1="16" x2="-95" y2="75" stroke="#2563eb" strokeWidth="1" strokeDasharray="2 2" />
                    <circle cx="-105" cy="85" r="14" fill="#ffffff" stroke="#2563eb" strokeWidth="1.2" />
                    <text x="-105" y="88" textAnchor="middle" fill="#2563eb" fontSize="7" fontWeight="bold">CAST</text>

                    {/* Node 4: Sheet Metal (Bottom Right) */}
                    <line x1="16" y1="16" x2="95" y2="75" stroke="#2563eb" strokeWidth="1" strokeDasharray="2 2" />
                    <circle cx="105" cy="85" r="14" fill="#ffffff" stroke="#2563eb" strokeWidth="1.2" />
                    <text x="105" y="88" textAnchor="middle" fill="#2563eb" fontSize="7" fontWeight="bold">SHEET</text>

                    {/* Node 5: 3D Printing (Direct Top) */}
                    <line x1="0" y1="-22" x2="0" y2="-85" stroke="#2563eb" strokeWidth="1" />
                    <circle cx="0" cy="-98" r="12" fill="#ffffff" stroke="#2563eb" strokeWidth="1.2" />
                    <text x="0" y="-95" textAnchor="middle" fill="#2563eb" fontSize="7" fontWeight="bold">3D</text>
                </g>

                {/* Technical Annotation Labels — kept inside viewBox */}
                <text x="24" y="28" fill="#2563eb" fontSize="8" letterSpacing="0.12em">
                    TOPOLOGY // COORDINATED MANUFACTURING
                </text>
                <text x="24" y="42" fill="#2563eb" fontSize="7.5" letterSpacing="0.1em">
                    NETWORK · 15+ AUDITED SITES
                </text>
                <text x="50" y="300" fill="#2563eb" fontSize="7.5" letterSpacing="0.08em">
...
export default function AboutUsPage() {
    return (
        <main className="w-full bg-white text-slate-900 selection:bg-[#2563eb] selection:text-white">
                        ...
                        <div>
                            ...
                            <div className="mt-8 border-t border-slate-200 pt-6">
                                <p className="text-xl font-bold leading-snug text-slate-900">
                                    ...
                                    <br />
                                    <span className="text-[#2563eb]">Global export precision.</span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {/* ========================================================== */}
            <section className="py-20 lg:py-28 bg-[#ffffff] border-y border-slate-200">
                <div className="mx-auto max-w-7xl px-6 lg:px-16">
                            ...
                            >
                                <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:items-baseline lg:gap-10">
                                    <div className="lg:col-span-2 flex items-baseline gap-3">
                                        <span className="text-xs font-bold text-[#2563eb] tabular">
                                            {item.number}
                                        </span>
                        ...
                        <div className="border-t border-slate-800 pt-8 lg:border-t-0 lg:border-l lg:border-slate-800 lg:pl-12 lg:pt-0">
                            ...
                            <div className="mt-6 space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-bold text-white">Focal Point Industrial District</p>
                                ...
                                <div className="flex items-start gap-3">
                                    <span className="mt-1 h-2 w-2 rounded-full bg-[#2563eb]" />
                                    <div>
                                        <p className="text-sm font-bold text-white">Full Process Coverage</p>
                                ...
                                <div className="flex items-start gap-3">
                                    <span className="mt-1 h-2 w-2 rounded-full bg-[#2563eb]" />
                                    <div>
                                        <p className="text-sm font-bold text-white">Worldwide Sea &amp; Air Freight</p>
